...
df_category = pd.get_dummies(df['Attrition_Flag'])
df = pd.concat([df, df_category], axis=1)
df_category = pd.get_dummies(df['Gender'])
df = pd.concat([df, df_category], axis=1)
df_category = pd.get_dummies(df['Marital_Status'])
df = pd.concat([df, df_category], axis=1)
df_category = pd.get_dummies(df['Card_Category'])
df = pd.concat([df, df_category], axis=1)
df_category = pd.get_dummies(df['Education_Level'])
df = pd.concat([df, df_category], axis=1)
df_category = pd.get_dummies(df['Income_Category'])
df = pd.concat([df, df_category], axis=1)
